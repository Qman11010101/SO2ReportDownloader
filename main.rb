...
# ディレクトリがなければ作成
if Dir.exist?("./so2stockdata") == false
    Dir.mkdir("./so2stockdata")
end
if Dir.exist?("./so2stockdata/buy_reports") == false
    Dir.mkdir("./so2stockdata/buy_reports")
end
if Dir.exist?("./so2stockdata/ranking") == false
    Dir.mkdir("./so2stockdata/ranking")
end
if Dir.exist?("./so2stockdata/ranking/all_top3_monthly") == false
    Dir.mkdir("./so2stockdata/ranking/all_top3_monthly")
end
if Dir.exist?("./so2stockdata/ranking/top1000_monthly") == false
